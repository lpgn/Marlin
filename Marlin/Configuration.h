...
<<<<<<< HEAD
#define STRING_VERSION_CONFIG_H __DATE__ "2015-feb" __TIME__ "00:01" // build date and time
#define STRING_CONFIG_H_AUTHOR "(Lucio, LCD ready, big alum)" // Who made the changes.
=======
...
#define CUSTOM_MENDEL_NAME "Makerthink"
...
// Ultimaker
    #define  DEFAULT_Kp 196.42
    #define  DEFAULT_Ki 28.21
    #define  DEFAULT_Kd 341.94
...
<<<<<<< HEAD
#define DEFAULT_AXIS_STEPS_PER_UNIT   {64.1,64.1,638.21,357}  // Motor step angle 1.8 microstepping 1/16 belt pitch 2.03 mxl toth count 15 Y 28 X // default steps per unit for Ultimaker
